                            ...
                            <div class="GridLex-col-3_sm-4_xs-12">
                                ...
                                <div class="admin-sidebar">
                                    ...
                                    <ul class="admin-user-menu clearfix">
                                        ...
                                        <li>
                                            <a href="qualifications.php"><i class="fa fa-trophy"></i> Professional
                                                Qualifications</a>
                                        </li>
                                        <li>
                                        ...
                                        <li class="active">
                                            <a href="academic.php"><i class="fa fa-graduation-cap"></i> Academic
                                                Qualifications</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="attachments.php"><i class="fa fa-folder-open"></i> Other
                                                Attachments</a>
                                        </li>
                                        <li>
                                            <a href="applied-jobs.php"><i class="fa fa-bookmark"></i> Applied Jobs</a>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-10">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <a target="_blank"
                                                            href="view-certificate-c.php?id=<?php echo $row['id']; ?>">
                                                ...
                                                <div class="col-sm-12 col-md-2">
                                                    ...
                                                    <div class="resume-list-btn">
                                                        ...
                                                        <a href="app/drop-academic.php?id=<?php echo $row['id']; ?>"
                                                        ...
                                                        <div id="edit<?php echo $row['id']; ?>"
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="app/update-academic-qualification.php"
                                                                        ...
                                                                        <div class="col-sm-12 col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="level" required
                                                                                    ...
                                                                                    <option
                                                                                        <?php if ($level == "Advanced Diploma") { print ' selected '; } ?>
                                                                                        value="Advanced Diploma">
                                                                                        Advanced Diploma</option>
                                                                                    <option
                                                                                        <?php if ($level == "Advanced Level (ACSE)") { print ' selected '; } ?>
                                                                                        value="Advanced Level (ACSE)">
                                                                                        Advanced Level (ACSE)</option>
                                                                                    <option
                                                                                        <?php if ($level == "Certificate") { print ' selected '; } ?>
                                                                                        value="Certificate">Certificate
                                                                                    </option>
                                                                                    <option
                                                                                        <?php if ($level == "Degree") { print ' selected '; } ?>
                                                                                        value="Degree">Degree</option>
                                                                                    <option
                                                                                        <?php if ($level == "Diploma") { print ' selected '; } ?>
                                                                                        value="Diploma">Diploma</option>
                                                                                    <option
                                                                                        <?php if ($level == "Master Degree") { print ' selected '; } ?>
                                                                                        value="Master Degree">Master
                                                                                        Degree</option>
                                                                                    <option
                                                                                        <?php if ($level == "Ordinary Level (CSE)") { print ' selected '; } ?>
                                                                                        value="Ordinary Level (CSE)">
                                                                                        Ordinary Level (CSE)</option>
                                                                                    <option
                                                                                        <?php if ($level == "PHd") { print ' selected '; } ?>
                                                                                        value="PHd">PHd</option>
                                                                                    <option
                                                                                        <?php if ($level == "Post Graduate Diploma") { print ' selected '; } ?>
...
<option <?php if ($country == $rowb['country_name']) { print ' selected '; } ?> value="<?php echo $rowb['country_name']; ?>"><?php echo $rowb['country_name']; ?></option>
									 ...
									 ?>
                                                                        ...
                                                                        <div class="col-sm-12 col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control"
                                                                                    value="<?php echo "$timeframe"; ?>"
                                                                                    placeholder="Eg: 2015 To 2016"
                                                                                    type="text" name="timeframe"
                                                                                    required>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-sm-12 col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Certificate <i>(Leave blank if
                                                                                        you dont want to
                                                                                        update)</i></label>
                                                                                <input class="form-control"
                                                                        ...
                                                                        <div class="col-sm-12 col-md-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Transcript <i>(Leave blank if you
                                                                                        dont want to update)</i></label>
                                                                                <input class="form-control"
                                                                                    accept="application/pdf" type="file"
                                                                                    name="transcript">
                                                                            </div>
		                        ...
		                        ?><li class="paging-nav"><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>
                                                        href="academic.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a>
                                                </li><?php
                                 }	
...
<div class="bottom-footer"></div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Attach your certificate</label>
                                                            <input class="form-control" accept="application/pdf"
                                                                type="file" name="certificate" required>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Academic Transcript</label>
                                                            <input class="form-control" accept="application/pdf"
                                                                type="file" name="transcript" required>
                                                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            ...
                                            <div class="footer-about-us">
                                                ...
                                                <p>Nightingale Jobs is a job portal, online job management system
                                                    developed by Nathaniel Nkrumah for his project in february 2018.</p>
                                ...
                                <div class="col-sm-12 col-md-3 mt-30-sm">
                                    ...
                                    <p>Email : <a
                                            href="mailto:nightingale.nath2@gmail.com">nightingale.nath2@gmail.com</a>
                                    </p>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Nightingale Vision
                                        Software</p>
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <ul class="bottom-footer-menu for-social">
                                        <li><a href="<?php echo "$tw"; ?>"><i class="ri ri-twitter"
                                                    data-toggle="tooltip" data-placement="top" title="twitter"></i></a>
                                        </li>
                                        <li><a href="<?php echo "$fb"; ?>"><i class="ri ri-facebook"
                                                    data-toggle="tooltip" data-placement="top" title="facebook"></i></a>
                                        </li>
                                        <li><a href="<?php echo "$ig"; ?>"><i class="ri ri-instagram"
