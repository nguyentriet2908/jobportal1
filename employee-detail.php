...
try {
	...
	$current_year = date('Y');
	$current_year_num = intval($current_year);
	$byear_num = intval($byear);
	$myage = $current_year_num - $byear_num;
	$myedu = $row['education'];
	$mytitle = $row['title'];
	$mymail = $row['email'];
	}
...
<head>
    ...
    <title>BKJob - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="employee-detail-wrapper">
                                ...
                                <div class="employee-detail-header text-center">
                                    ...
                                    <p class="location"><i class="fa fa-map-marker"></i> <?php echo "$mycountry"; ?>,
                                        <?php echo "$mycity"; ?><span class="mh-5">|</span> <i class="fa fa-phone"></i>
                                        <?php echo "$myphone"; ?></p>
                                    ...
                                    <div class="admin-user-action text-center">
                                        <a target="_blank" href="employer/view_cv?employee=<?php echo $empid;?>" class="btn btn-primary btn-sm btn-inverse">View
                                            CV</a>
                                    </div>
                                ...
                                <div class="employee-detail-company-overview mt-40 clearfix">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <ul class="employee-detail-list">
                                                ...
                                                <li>
                                                    ...
                                                    <p class="text-muted font-italic">Level -
                                                        <?php echo $row['level']; ?> ,
                                                        <?php echo $row['timeframe']; ?><span
                                                            class="font600 text-primary">
                                                            <?php echo $row['institution']; ?></span>
                                                        <?php echo $row['country']; ?></p>
                                                    <p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm"
                                                            href="view-certificate.php?id=<?php echo $row['id']; ?>">View
                                                            Certificate</a></p>
                                                </li>
                                                <?php
	                                            }
                                    ...
                                    <ul class="employee-detail-list">
                                        ...
                                        <li>
                                            ...
                                            <p class="text-muted font-italic"><?php echo $row['start_date']; ?> to
                                                <?php echo $row['end_date']; ?><span class="font600 text-primary">
                                                    <?php echo $row['institution']; ?></span></p>
                                            <p>Supervisor : <span class="font600 text-primary">
                                                    <?php echo $row['supervisor']; ?></span> , Phone : <span
                                                    class="font600 text-primary">
                                                    <?php echo $row['supervisor_phone']; ?></span>
                                                <br><?php echo $row['duties']; ?>
                                            </p>
                                        </li>
                                        <?php
	                                            }
                                    ...
                                    <ul class="employee-detail-list">
                                        ...
                                        <li>
                                            ...
                                            <p class="text-muted font-italic"><span class="font600 text-primary">
                                                    <?php echo $row['institution']; ?></span>
                                                <?php echo $row['timeframe']; ?></p>
                                            <?php
												if ($certificate == "") {
												...
												?>
                                            <p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm"
                                                    href="view-certificate-b.php?id=<?php echo $row['id']; ?>">View
                                                    Certificate</a></p>
                                            <?php												
												}
                                    ...
                                    <ul class="employee-detail-list">
                                        ...
                                        <li>
                                            <h5><?php echo $row['title']; ?> </h5>
                                            <p class="text-muted font-italic"><?php echo $row['timeframe']; ?><span
                                                    class="font600 text-primary">
                                                    <?php echo $row['institution']; ?></span>
                                                <?php echo $row['country']; ?></p>
                                            <p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm"
                                                    href="view-certificate-c.php?id=<?php echo $row['id']; ?>">View
                                                    Certificate</a></p>
                                        </li>
                                        <?php
	                                            }
                                    ...
                                    <ul class="employee-detail-list">
                                        ...
                                        <li>
                                            ...
                                            <p><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm"
                                                    href="view-attachment.php?id=<?php echo $row['id']; ?>">View
                                                    Attachment</a></p>
                                        </li>
                                        <?php
	                                            }
                                    ...
                                    <ul class="employee-detail-list">
                                        ...
                                        <li>
                                            ...
                                            <p class="text-muted font-italic">Speaking <span
                                                    class="font600 text-primary"> <?php echo $row['speak']; ?></span> ,
                                                Reading <span class="font600 text-primary">
                                                    <?php echo $row['reading']; ?></span> , Writing <span
                                                    class="font600 text-primary"> <?php echo $row['writing']; ?></span>
                                            </p>
                                        </li>
                                        <?php
	                                            }
                                    ...
                                    <ul class="list-icon">
                                        ...
                                        <li>
                                            ...
                                            <p><?php echo $row['ref_title']; ?> <span
                                                    class="font600 text-primary"><?php echo $row['institution']; ?></span>
                                            </p>
                                            <p>Email : <a
                                                    href="mailto:<?php echo $row['ref_mail']; ?>"><?php echo $row['ref_mail']; ?></a>
                                            </p>
                                            <p>Phone : <a
                                                    href="tel:<?php echo $row['ref_phone']; ?>"><?php echo $row['ref_phone']; ?></a>
                                            </p>
