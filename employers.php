                        ...
                        <div class="GridLex-grid-middle">
                            ...
                            <div class="GridLex-col-3_sm-12_xs-12">
                                ...
                                <form method="post" action="employees.php" class="m-5">
                                    <input type="text" placeholder="Search employers" name="search" autocomplete="off">
                                    ...
                                    <div class="top-company-2">
                                        <a target="_blank" href="company.php?ref=<?php echo $row['member_no']; ?>">
                                            ...
                                            <div class="content">
                                                ...
                                                <p>
                                                <p class="mata-p clearfix"><span class="text-primary font700">25</span>
                                                    <span class="font13">Active job post(s)</span> <span
                                                        class="pull-right icon"><i
                                                            class="fa fa-long-arrow-right"></i></span></p>
                                            </div>
